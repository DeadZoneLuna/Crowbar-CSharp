...
namespace Crowbar.My
{
	internal sealed class MyApplication : Microsoft.VisualBasic.ApplicationServices.WindowsFormsApplicationBase
	{
		private static readonly MyApplication instance = new MyApplication();

		//[STAThread]
		//static void Main() { (new MainForm()).ShowDialog(); }
