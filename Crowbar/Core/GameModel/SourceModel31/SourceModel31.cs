...
#region Methods
		...
		public AppEnums.StatusMessage WriteMeshSmdFile(string smdPathFileName, int lodIndex, SourceVtxModel06 aVtxModel, SourceMdlModel31 aModel, int bodyPartVertexIndexStart)
		{
			...
			try
			{
				...
				SourceSmdFile31 smdFile = new SourceSmdFile31(theOutputFileTextWriter, theMdlFileData);
...
#region Private Methods
		...
		protected override void ReadMdlFileHeader_Internal()
		{
			...
			SourceMdlFile31 mdlFile = new SourceMdlFile31(theInputFileReader, theMdlFileData);
		...
		protected override void WriteQcFile()
		{
			...
			SourceQcFile31 qcFile = new SourceQcFile31(theOutputFileTextWriter, theQcPathFileName, theMdlFileData, theVtxFileData, thePhyFileDataGeneric, theName);
		...
		{
			SourceSmdFile31 physicsMeshSmdFile = new SourceSmdFile31(theOutputFileTextWriter, theMdlFileData, thePhyFileDataGeneric);
