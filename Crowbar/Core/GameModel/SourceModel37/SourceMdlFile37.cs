...
#region Methods
		...
		public void ReadMdlHeader00(string logDescription)
		{
			...
			{
				this.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + this.theMdlFileData.version.ToString() + "; override version: 37)");
			}
		}
		...
		public void ReadMdlHeader01(string logDescription)
		{
			...
			this.theMdlFileData.animationGroupCount = this.theInputFileReader.ReadInt32();
			this.theMdlFileData.animationGroupOffset = this.theInputFileReader.ReadInt32();

			this.theMdlFileData.boneDescCount = this.theInputFileReader.ReadInt32();
			this.theMdlFileData.boneDescOffset = this.theInputFileReader.ReadInt32();
		...
		{
			if (this.theMdlFileData.boneDescCount > 0)
			{
				long boneDescInputFileStreamPosition = 0;
				long inputFileStreamPosition = 0;
				long fileOffsetStart = 0;
				long fileOffsetEnd = 0;
				long fileOffsetStart2 = 0;
				...
				try
				{
					this.theInputFileReader.BaseStream.Seek(this.theMdlFileData.boneDescOffset, SeekOrigin.Begin);
					fileOffsetStart = this.theInputFileReader.BaseStream.Position;

					this.theMdlFileData.theBoneDescs = new List<SourceMdlBoneDesc37>(this.theMdlFileData.boneDescCount);
					for (int i = 0; i < this.theMdlFileData.boneCount; i++)
					{
						boneDescInputFileStreamPosition = this.theInputFileReader.BaseStream.Position;
						SourceMdlBoneDesc37 aBoneDesc = new SourceMdlBoneDesc37();

						aBoneDesc.nameOffset = this.theInputFileReader.ReadInt32();
						aBoneDesc.parentBoneIndex = this.theInputFileReader.ReadInt32();

						aBoneDesc.position = new SourceVector();
						aBoneDesc.position.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.position.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.position.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotation = new SourceVector();
						aBoneDesc.rotation.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotation.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotation.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.positionScale = new SourceVector();
						aBoneDesc.positionScale.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.positionScale.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.positionScale.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotationScale = new SourceVector();
						aBoneDesc.rotationScale.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotationScale.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.rotationScale.z = this.theInputFileReader.ReadSingle();
						...
						aBoneDesc.poseToBoneColumn0.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn1.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn2.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn3.x = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn0.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn1.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn2.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn3.y = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn0.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn1.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn2.z = this.theInputFileReader.ReadSingle();
						aBoneDesc.poseToBoneColumn3.z = this.theInputFileReader.ReadSingle();

						for (int x = 0; x < aBoneDesc.unused.Length; x++)
						{
							aBoneDesc.unused[x] = this.theInputFileReader.ReadInt32();
						}

						this.theMdlFileData.theBoneDescs.Add(aBoneDesc);

						inputFileStreamPosition = this.theInputFileReader.BaseStream.Position;

						if (aBoneDesc.nameOffset != 0)
						{
							this.theInputFileReader.BaseStream.Seek(boneDescInputFileStreamPosition + aBoneDesc.nameOffset, SeekOrigin.Begin);
							fileOffsetStart2 = this.theInputFileReader.BaseStream.Position;

							aBoneDesc.theName = FileManager.ReadNullTerminatedString(this.theInputFileReader);

							fileOffsetEnd2 = this.theInputFileReader.BaseStream.Position - 1;
							if (!this.theMdlFileData.theFileSeekLog.ContainsKey(fileOffsetStart2))
							{
								this.theMdlFileData.theFileSeekLog.Add(fileOffsetStart2, fileOffsetEnd2, "aBoneDesc.theName = " + aBoneDesc.theName);
							}
						}
						else if (aBoneDesc.theName == null)
						{
							aBoneDesc.theName = "";
						}
					...
					fileOffsetEnd = this.theInputFileReader.BaseStream.Position - 1;
					this.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "theMdlFileData.theBoneDescs " + this.theMdlFileData.theBoneDescs.Count.ToString());
		...
		{
			if (this.theMdlFileData.animationGroupCount > 0)
			{
				...
				try
				{
					this.theInputFileReader.BaseStream.Seek(this.theMdlFileData.animationGroupOffset, SeekOrigin.Begin);
					fileOffsetStart = this.theInputFileReader.BaseStream.Position;

					this.theMdlFileData.theAnimGroups = new List<SourceMdlAnimGroup37>(this.theMdlFileData.animationGroupCount);
					for (int i = 0; i < this.theMdlFileData.animationGroupCount; i++)
					{
						//seqInputFileStreamPosition = Me.theInputFileReader.BaseStream.Position
						SourceMdlAnimGroup37 anAnimGroup = new SourceMdlAnimGroup37();

						anAnimGroup.group = this.theInputFileReader.ReadInt32();
						anAnimGroup.index = this.theInputFileReader.ReadInt32();

						this.theMdlFileData.theAnimGroups.Add(anAnimGroup);
					...
					fileOffsetEnd = this.theInputFileReader.BaseStream.Position - 1;
					this.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "theMdlFileData.theAnimGroups " + this.theMdlFileData.theAnimGroups.Count.ToString());

					this.theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(this.theInputFileReader, fileOffsetEnd, 4, "theMdlFileData.theAnimGroups alignment");
				}
				catch (Exception ex)
				{
					int debug = 4242;
		...
		public void ReadSequences()
		{
			if (this.theMdlFileData.localSequenceCount > 0)
			{
				...
				try
				{
					...
					this.theMdlFileData.theSequenceDescs = new List<SourceMdlSequenceDesc37>(this.theMdlFileData.localSequenceCount);
					for (int i = 0; i < this.theMdlFileData.localSequenceCount; i++)
					{
						...
						SourceMdlSequenceDesc37 aSeqDesc = new SourceMdlSequenceDesc37();
		...
		public void ReadSequenceGroups()
		{
			if (this.theMdlFileData.sequenceGroupCount > 0)
			{
				...
				try
				{
					...
					this.theMdlFileData.theIncludeModelFileNames = new List<string>();
					for (int sequenceGroupIndex = 0; sequenceGroupIndex < this.theMdlFileData.sequenceGroupCount; sequenceGroupIndex++)
					{
						...
						{
							this.theMdlFileData.theIncludeModelFileNames.Add(aSequenceGroup.theFileName);
						}
		...
		public void ReadLocalAnimationDescs()
		{
			if (this.theMdlFileData.animationCount > 0)
			{
				...
				try
				{
					...
					this.theMdlFileData.theAnimationDescs = new List<SourceMdlAnimationDesc37>(this.theMdlFileData.animationCount);
					for (int i = 0; i < this.theMdlFileData.animationCount; i++)
					{
						...
						//fileOffsetStart = Me.theInputFileReader.BaseStream.Position
						SourceMdlAnimationDesc37 anAnimationDesc = new SourceMdlAnimationDesc37();
...
#region Private Methods
		...
		private void ReadMdlAnimIndexes(long seqInputFileStreamPosition, SourceMdlSequenceDesc37 aSeqDesc)
		{
			if ((aSeqDesc.groupSize[0] * aSeqDesc.groupSize[1]) > 0 && aSeqDesc.blendOffset != 0)
			{
				try
				{
					...
					this.theInputFileReader.BaseStream.Seek(seqInputFileStreamPosition + aSeqDesc.blendOffset, SeekOrigin.Begin);
					fileOffsetStart = this.theInputFileReader.BaseStream.Position;
					...
					if (!this.theMdlFileData.theFileSeekLog.ContainsKey(fileOffsetStart))
					{
						this.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, "aSeqDesc.theAnimDescIndexes " + aSeqDesc.theAnimDescIndexes.Count.ToString());
					}

					this.theMdlFileData.theFileSeekLog.LogToEndAndAlignToNextStart(this.theInputFileReader, fileOffsetEnd, 4, "aSeqDesc.theAnimDescIndexes alignment");
				}
				catch (Exception ex)
				{
					int debug = 4242;
		...
		private void ReadVertexes(long modelInputFileStreamPosition, SourceMdlModel37 aModel)
		{
			if (aModel.vertexCount > 0 && aModel.vertexOffset != 0)
			{
				...
				try
				{
					...
					if (this.theMdlFileData.theVertexes == null)
					{
						this.theMdlFileData.theVertexes = new List<SourceMdlVertex37>();
					}
					...
					for (int vertexIndex = 0; vertexIndex < aModel.vertexCount; vertexIndex++)
					{
						...
						this.theMdlFileData.theVertexes.Add(aVertex);
		...
		public void CreateFlexFrameList()
		{
			...
			this.theMdlFileData.theFlexFrames = new List<FlexFrame37>();
