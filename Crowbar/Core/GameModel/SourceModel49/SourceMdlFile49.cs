				...
				foreach (SourceMdlAnimationDesc49 anAnimationDesc in theMdlFileData.theAnimationDescs)
				{
					try
					{
						...
						if (anAnimationDesc.theSections != null && anAnimationDesc.theSections.Count > 0)
						{
							...
							for (int sectionIndex = 0; sectionIndex < sectionCount; sectionIndex++)
							{
								SourceMdlAnimationSection section = anAnimationDesc.theSections[sectionIndex];
								if (section.animBlock == 0)
								{
									...
									long adjustedAnimOffset = section.animOffset + (anAnimationDesc.animOffset - anAnimationDesc.theSections[0].animOffset);
							...
							ReadAnimationFrames(animInputFileStreamPosition + anAnimationDesc.animOffset, anAnimationDesc, anAnimationDesc.frameCount, 0, true);
