...
//INSTANT C# NOTE: There is no C# equivalent to VB's implicit 'once only' variable initialization within loops, so the following variable declaration has been placed prior to the loop:
	...
	//						Dim anAimName As String
							...
							line = "<aimvector>";
							line += " ";
							line += aBone.theAimAtBone.aim.x.ToString("0.######", MainCROWBAR.TheApp.InternalNumberFormat);
							line += " ";
							...
							line = "<upvector>";
							line += " ";
							line += aBone.theAimAtBone.up.x.ToString("0.######", MainCROWBAR.TheApp.InternalNumberFormat);
							line += " ";
							...
							line = "<basepos>";
							line += " ";
							line += aBone.theAimAtBone.basePos.x.ToString("0.######", MainCROWBAR.TheApp.InternalNumberFormat);
							line += " ";
