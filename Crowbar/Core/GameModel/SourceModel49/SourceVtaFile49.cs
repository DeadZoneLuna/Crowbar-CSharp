...
#region Methods
		...
		public void WriteSkeletonSectionForVertexAnimation()
		{
			...
			for (flexTimeIndex = 1; flexTimeIndex < this.theBodyPart.theFlexFrames.Count; flexTimeIndex++)
			{
				aFlexFrame = this.theBodyPart.theFlexFrames[flexTimeIndex];
